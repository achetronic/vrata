...
| JWT (RSA signature, JWKS remote+inline, claims, refresh) | 100% | Unit (9 tests) |
| ExtAuthz (allow/deny, headers, body, failureMode) | 100% | Unit (7 tests) |
| ExtProc HTTP mode | 100% | Unit (16 tests) |
...
| Proxy router | 8 | 8 |
| CEL eval | 11 | 11 |
| Proxy middlewares (CORS, headers, accesslog, extproc, ratelimit, JWT, extauthz) | 44 | 44 |
| Sync client | 2 | 2 |
| Config | 5 | 5 |
| E2E (live) | 24 | 24 |
| **Total** | **156** | **156** |
...
| Limitation | Notes |
|---|---|
| JWT only RSA keys | No EC/Ed25519. Covers >90% of deployments |
| ExtAuthz HTTP only | gRPC mode not implemented. HTTP covers most use cases |
| ExtProc body streaming | STREAMED and BUFFERED_PARTIAL modes not yet implemented. BUFFERED covers most use cases |
