...
│   ├── mapper/                 # HTTPRoute/GRPCRoute/Gateway → Vrata entities (pure, no I/O)
...
│   ├── status/                 # HTTPRoute/GRPCRoute/Gateway/GatewayClass status condition writer
│   ├── refgrant/               # ReferenceGrant cross-namespace checker (HTTPRoute + GRPCRoute)
