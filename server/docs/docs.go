        ...
        "schemas": {
            ...
            "model.ExtAuthzConfig": {
                ...
                "properties": {
                    "allowedClientHeaders": {
                        "description": "AllowedClientHeaders lists header patterns from the authz response\nthat are returned to the client when the authz service denies.",
                        "items": {
                            "type": "string"
                        },
                        "type": "array",
                    ...
                    "headersToAdd": {
                        "description": "HeadersToAdd are extra headers injected into the check request sent\nto the authz service.",
                        "items": {
            ...
            "model.ForwardAction": {
                ...
                "properties": {
                    ...
                    "internalRedirect": {
                        "$ref": "#/components/schemas/model.InternalRedirectPolicy"
                    },
                    "maxGrpcTimeout": {
            ...
            "model.InternalRedirectPolicy": {
                "description": "InternalRedirect controls Envoy's behaviour when the upstream returns\na redirect (3xx). Instead of forwarding the redirect to the client,\nEnvoy can follow it internally and return the final response.",
                "properties": {
                    "allowCrossScheme": {
                        "description": "AllowCrossScheme allows internal redirects that change the scheme\n(e.g. http to https). Default: false.",
                        "type": "boolean"
                    },
                    "maxRedirects": {
                        "description": "MaxRedirects is the maximum number of internal redirects Envoy will\nfollow before returning the redirect to the client. Default: 1.",
                        "type": "integer"
                    },
                    "redirectCodes": {
                        "description": "RedirectCodes lists the HTTP status codes treated as redirects.\nDefault: [302]. Other common values: 301, 303, 307, 308.",
                        "items": {
                            "type": "integer"
                        },
                        "type": "array",
